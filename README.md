...
My code is AI-assisted. I'm still learning, so I might not have a deep answer
for every implementation choice. Improvements, feedback, bug reports, and
patient explanations are always appreciated.

You can find me on Discord as **@ryuki.kiyomizu**.

<sub>typed with paws; accuracy not guaranteed. awrooooooooooo~</sub>
